...
save_dataset_filename = "./data/quad_sim_scenario_2.npz"  # save dataset here
...
(
    ...
    num_states=num_states, num_actions=num_actions, env=env, omit_data_mask=omit_data_mask
)
