...
\node (qr) at (71.5,4.8) {\includegraphics[width=0.045\columnwidth]{fig/github-qr-code.png}};
\node (logo) at (78.5,5) {\includegraphics[height=.05\paperwidth,trim=2.5cm 2.5cm 2.5cm 2cm]{fig/aalto}};
...
\begin{minipage}{\textwidth}
  ...
  \begin{tikzpicture}[inner sep=0,outer sep=0]
     ...
     \node at (0,100) {
        ...
        \includegraphics[width=0.63\textwidth, trim= 0 30 49 5, clip]{../experiments/figures/moderl_four_iterations_in_row.pdf}
  ...
  \begin{figure}
      \resizebox{0.7\columnwidth}{!}{
        ...
        \centering
            ...
            \node[latent, right=of x, yshift=-1.4cm, xshift=1.2cm] (h) {{\footnotesize$\mode{\gatingFunc}(\state_{\timeInd})$}};
            ...
            \node[obs, right=of sigmak, yshift=0.cm, xshift=1.4cm] (y) {{\footnotesize$\singleOutput$}};
            %\node[latent, right=of y, below=of h] (a) {$\alpha_t$};
            \node[latent, right=of y, xshift=-0.4cm] (a) {{\footnotesize$\modeVar_{\timeInd}$}};
...
\begin{column}{\colwidth}
  ...
  \begin{figure}[H]
    \begin{tikzpicture}[inner sep=0,outer sep=0]
     ...
     \includegraphics[width=0.5\columnwidth, trim=0 7 0 15, clip]{../experiments/figures/num_constrint_violations_constraint_levels_ablation.pdf}
          \includegraphics[width=0.5\columnwidth, trim=0 7 0 15, clip]{../experiments/figures/episode_return_constraint_levels_ablation.pdf}
      };
    \end{tikzpicture}
