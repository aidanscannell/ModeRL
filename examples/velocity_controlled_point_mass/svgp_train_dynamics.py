...
@hydra.main(
    ...
    config_name="svgp_train_dynamics",
)
def svgp_train_dynamics_from_cfg(cfg: DictConfig):
    ...
    def maximum_log_likelihood_objective(self, data: Dataset):
        return self.experts_list[0].gp.elbo(data)

    mode_optimiser.dynamics.mosvgpe.maximum_log_likelihood_objective = types.MethodType(
        maximum_log_likelihood_objective, mode_optimiser.dynamics.mosvgpe
    )
