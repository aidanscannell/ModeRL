...
from modeopt.trajectory_optimisers import ModeVariationalTrajectoryOptimiserTrainingSpec

from scenario_4.data.load_data import load_vcpm_dataset
from scenario_4.utils import init_mode_opt, velocity_controlled_point_mass_dynamics
...
def run_mode_opt_remain(
    ...
    mode_optimiser = init_mode_opt(dataset=dataset)
